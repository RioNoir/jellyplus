...
{
    protected $signature = 'library:update-item {--itemId=}';
    protected $description = 'Command to update Items of Jellyplus Library';
    ...
    public function handle()
    {
        ...
        try {
            ...
            Log::info('[' . $this->getName() . '] ' . $itemId . ' item updated.');
            $this->info('[' . $this->getName() . '] ' . $itemId . ' item updated.');
